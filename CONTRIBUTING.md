...
1. Fork the [Cryptocurrency-TOOLS/hummingbot](https://github.com/Cryptocurrency-TOOLS/hummingbot) repository.
...
```
git remote add upstream https://github.com/Cryptocurrency-TOOLS/hummingbot.git
git fetch upstream
```
